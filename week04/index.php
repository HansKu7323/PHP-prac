...
<html lang="zh-TW">
	...
	<body>
		<nav>
			<ul>
				<li><a href="array.php">資料型態-陣列</a></li>
				<li><a href="for.php">迴圈控制-for</a></li>
				<li><a href="while.php">迴圈控制-while</a></li>
				<li><a href="foreach.php">迴圈控制-foreach</a></li>
				<li><a href="class_work.php">課堂作業</a></li>
			</ul>
		</nav>
	</body>
</html>
